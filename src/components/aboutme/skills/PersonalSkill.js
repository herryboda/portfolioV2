            ...
            <Container>
                <Row className='g-5'>
                    <Col md={4}>
                        ...
                        <h2 style={{color:'#fe3e57',fontSize:'25px',marginTop:'13px',fontWeight:700 }}>Communication and Interpersonal Skills</h2>
                        </div>
                    </Col>
                    <Col md={4}>
                        ...
                        <h2 style={{color:'#54faae',fontSize:'25px',marginTop:'13px',fontWeight:700 }}>Leadership</h2>
                        </div>
                    </Col>
                    <Col md={4}>
                        <h1 style={{ fontSize: '100px',color:'#ff8c2f',fontWeight:700}}>95%</h1>
                        <div style={{ paddingLeft: '50px',paddingRight:'50px'}}>
                        <div class="progress">
                        ...
                        <h2 style={{color:'#ff8c2f',fontSize:'25px',marginTop:'13px',fontWeight:700 }}>Problem-Solving and Critical Thinking</h2>
                        </div>
                    </Col>
                    <Col md={4}>
                    ...
                    <Col md={4}>
                        ...
                        <h2 style={{color:'#ff0173',fontSize:'25px',marginTop:'13px',fontWeight:700 }}>Conflict Resolution and Negotiation</h2>
                        </div>
                    </Col>
                    <Col md={4}>
